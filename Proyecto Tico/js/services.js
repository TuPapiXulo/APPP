...
myApp.services = {
  ...
  fixtures: [
    {
      title: 'Cena con Guallo',
      category: 'Vida Social',
      description: 'Ir al Dominos a las 9pm',
      highlight: false,
      urgent: false
    },
    {
      ...
      category: 'Estudios',
      description: 'Desde el punto 10 al 12',
      highlight: false,
      urgent: false
    },
    {
      title: 'Quedar con los amigos',
      category: 'Vida Social',
      description: 'En el parque del Retiro',
      highlight: false,
      urgent: false
    },
